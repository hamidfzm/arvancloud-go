...
// checks if the CreateImageFromSnapshotRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateImageFromSnapshotRequest{}
...
func NewCreateImageFromSnapshotRequest() *CreateImageFromSnapshotRequest {
	this := CreateImageFromSnapshotRequest{}
	return &this
}
...
type NullableCreateImageFromSnapshotRequest struct {
	value *CreateImageFromSnapshotRequest
	isSet bool
}
...
func NewNullableCreateImageFromSnapshotRequest(val *CreateImageFromSnapshotRequest) *NullableCreateImageFromSnapshotRequest {
	return &NullableCreateImageFromSnapshotRequest{value: val, isSet: true}
}
