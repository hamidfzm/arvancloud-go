...
func (r QuotaAPIGetUserLimitsRequest) Execute() (*Quota, *http.Response, error) {
...
func (a *QuotaAPIService) GetUserLimitsExecute(r QuotaAPIGetUserLimitsRequest) (*Quota, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "QuotaAPIService.GetUserLimits")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/regions/:region/quota"
