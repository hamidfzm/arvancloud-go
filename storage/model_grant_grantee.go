...
// checks if the GrantGrantee type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GrantGrantee{}
...
func (v NullableGrantGrantee) Get() *GrantGrantee {
	return v.value
}
...
func NewNullableGrantGrantee(val *GrantGrantee) *NullableGrantGrantee {
	return &NullableGrantGrantee{value: val, isSet: true}
}
