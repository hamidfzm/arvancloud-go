...
func (v *FileHeaderInfo) UnmarshalJSON(src []byte) error {
	...
	enumTypeValue := FileHeaderInfo(value)
	for _, existing := range AllowedFileHeaderInfoEnumValues {
	...
	return fmt.Errorf("%+v is not a valid FileHeaderInfo", value)
}

// NewFileHeaderInfoFromValue returns a pointer to a valid FileHeaderInfo
...
func NewFileHeaderInfoFromValue(v string) (*FileHeaderInfo, error) {
	...
	if ev.IsValid() {
		...
		return nil, fmt.Errorf("invalid value '%v' for FileHeaderInfo: valid values are %v", v, AllowedFileHeaderInfoEnumValues)
	}
}
...
func (v NullableFileHeaderInfo) Get() *FileHeaderInfo {
	return v.value
}

func (v *NullableFileHeaderInfo) Set(val *FileHeaderInfo) {
	v.value = val
	v.isSet = true
}
...
func NewNullableFileHeaderInfo(val *FileHeaderInfo) *NullableFileHeaderInfo {
	return &NullableFileHeaderInfo{value: val, isSet: true}
}
