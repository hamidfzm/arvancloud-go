...
// checks if the UserMetadataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserMetadataInner{}
...
type NullableUserMetadataInner struct {
	value *UserMetadataInner
	isSet bool
}

func (v NullableUserMetadataInner) Get() *UserMetadataInner {
	return v.value
}

func (v *NullableUserMetadataInner) Set(val *UserMetadataInner) {
	v.value = val
	v.isSet = true
}
...
func NewNullableUserMetadataInner(val *UserMetadataInner) *NullableUserMetadataInner {
	return &NullableUserMetadataInner{value: val, isSet: true}
}
