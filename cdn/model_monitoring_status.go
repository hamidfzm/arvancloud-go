...
const (
	MONITORINGSTATUS_OFF MonitoringStatus = "off"
	MONITORINGSTATUS_NO_DATA MonitoringStatus = "no-data"
	MONITORINGSTATUS_HEALTHY MonitoringStatus = "healthy"
	MONITORINGSTATUS_UNHEALTHY MonitoringStatus = "unhealthy"
)
