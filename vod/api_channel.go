...
type ApiChannelsChannelPatchRequest struct {
	...
	ApiService *ChannelAPIService
	channel string
	body *ChannelsChannelPatchRequest
}
...
func (r ApiChannelsChannelPatchRequest) Execute() (*http.Response, error) {
	return r.ApiService.ChannelsChannelPatchExecute(r)
}
...
func (a *ChannelAPIService) ChannelsChannelPatchExecute(r ApiChannelsChannelPatchRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ChannelAPIService.ChannelsChannelPatch")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
