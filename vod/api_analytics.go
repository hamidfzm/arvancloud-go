...
func (a *AnalyticsAPIService) AnalyticsPlayCountGetExecute(r ApiAnalyticsPlayCountGetRequest) (*http.Response, error) {
	...
	if r.filtersChannel != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "filters.channel", r.filtersChannel, "csv")
	}
	if r.filtersVideo != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "filters.video", r.filtersVideo, "csv")
	}
