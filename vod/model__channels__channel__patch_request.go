...
// checks if the ChannelsChannelPatchRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChannelsChannelPatchRequest{}
...
func NewChannelsChannelPatchRequest() *ChannelsChannelPatchRequest {
	this := ChannelsChannelPatchRequest{}
	return &this
}
...
type NullableChannelsChannelPatchRequest struct {
	value *ChannelsChannelPatchRequest
	isSet bool
}
...
func NewNullableChannelsChannelPatchRequest(val *ChannelsChannelPatchRequest) *NullableChannelsChannelPatchRequest {
	return &NullableChannelsChannelPatchRequest{value: val, isSet: true}
}
