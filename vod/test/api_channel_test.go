...
func Test_vod_ChannelAPIService(t *testing.T) {
	...
	t.Run("Test ChannelAPIService ChannelsChannelPatch", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var channel string

		httpRes, err := apiClient.ChannelAPI.ChannelsChannelPatch(context.Background(), channel).Execute()
