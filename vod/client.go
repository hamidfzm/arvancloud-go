...
// APIClient manages communication with the Arvan VOD API v2.0
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.WatermarkAPI = (*WatermarkAPIService)(&c.common)
