...
// checks if the V1ServiceList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1ServiceList{}
...
func (v NullableV1ServiceList) Get() *V1ServiceList {
	return v.value
}
...
func NewNullableV1ServiceList(val *V1ServiceList) *NullableV1ServiceList {
	return &NullableV1ServiceList{value: val, isSet: true}
}
