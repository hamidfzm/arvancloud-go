...
// checks if the V1PersistentVolumeClaimList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1PersistentVolumeClaimList{}
...
func NewV1PersistentVolumeClaimList(items []V1PersistentVolumeClaim) *V1PersistentVolumeClaimList {
	this := V1PersistentVolumeClaimList{}
	this.Items = items
	return &this
}
...
type NullableV1PersistentVolumeClaimList struct {
	value *V1PersistentVolumeClaimList
	isSet bool
}

func (v NullableV1PersistentVolumeClaimList) Get() *V1PersistentVolumeClaimList {
	return v.value
}

func (v *NullableV1PersistentVolumeClaimList) Set(val *V1PersistentVolumeClaimList) {
	v.value = val
	v.isSet = true
}

func (v NullableV1PersistentVolumeClaimList) IsSet() bool {
	return v.isSet
}

func (v *NullableV1PersistentVolumeClaimList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV1PersistentVolumeClaimList(val *V1PersistentVolumeClaimList) *NullableV1PersistentVolumeClaimList {
	return &NullableV1PersistentVolumeClaimList{value: val, isSet: true}
}
