...
// checks if the V1NamespaceList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1NamespaceList{}
...
type NullableV1NamespaceList struct {
	value *V1NamespaceList
	isSet bool
}

func (v NullableV1NamespaceList) Get() *V1NamespaceList {
	return v.value
}

func (v *NullableV1NamespaceList) Set(val *V1NamespaceList) {
	v.value = val
	v.isSet = true
}
...
func NewNullableV1NamespaceList(val *V1NamespaceList) *NullableV1NamespaceList {
	return &NullableV1NamespaceList{value: val, isSet: true}
}
