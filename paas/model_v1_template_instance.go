...
// checks if the V1TemplateInstance type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1TemplateInstance{}
...
func (o *V1TemplateInstance) GetSpec() V1TemplateInstanceSpec {
	if o == nil {
		var ret V1TemplateInstanceSpec
		return ret
	}
...
func (o *V1TemplateInstance) GetStatus() V1TemplateInstanceStatus {
	if o == nil {
		var ret V1TemplateInstanceStatus
		return ret
	}
...
type NullableV1TemplateInstance struct {
	value *V1TemplateInstance
	isSet bool
}

func (v NullableV1TemplateInstance) Get() *V1TemplateInstance {
	return v.value
}

func (v *NullableV1TemplateInstance) Set(val *V1TemplateInstance) {
	v.value = val
	v.isSet = true
}
...
func NewNullableV1TemplateInstance(val *V1TemplateInstance) *NullableV1TemplateInstance {
	return &NullableV1TemplateInstance{value: val, isSet: true}
}
