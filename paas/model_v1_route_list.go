...
// checks if the V1RouteList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1RouteList{}
...
func (v NullableV1RouteList) Get() *V1RouteList {
	return v.value
}
...
func NewNullableV1RouteList(val *V1RouteList) *NullableV1RouteList {
	return &NullableV1RouteList{value: val, isSet: true}
}
