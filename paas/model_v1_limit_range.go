...
// checks if the V1LimitRange type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1LimitRange{}
...
func (v NullableV1LimitRange) Get() *V1LimitRange {
	return v.value
}
...
func NewNullableV1LimitRange(val *V1LimitRange) *NullableV1LimitRange {
	return &NullableV1LimitRange{value: val, isSet: true}
}
