...
// checks if the V1PersistentVolumeList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1PersistentVolumeList{}
...
type NullableV1PersistentVolumeList struct {
	value *V1PersistentVolumeList
	isSet bool
}

func (v NullableV1PersistentVolumeList) Get() *V1PersistentVolumeList {
	return v.value
}

func (v *NullableV1PersistentVolumeList) Set(val *V1PersistentVolumeList) {
	v.value = val
	v.isSet = true
}

func (v NullableV1PersistentVolumeList) IsSet() bool {
	return v.isSet
}
...
func NewNullableV1PersistentVolumeList(val *V1PersistentVolumeList) *NullableV1PersistentVolumeList {
	return &NullableV1PersistentVolumeList{value: val, isSet: true}
}
