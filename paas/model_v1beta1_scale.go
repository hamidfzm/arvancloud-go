...
// checks if the V1beta1Scale type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1beta1Scale{}
...
func (v NullableV1beta1Scale) Get() *V1beta1Scale {
	return v.value
}
...
func NewNullableV1beta1Scale(val *V1beta1Scale) *NullableV1beta1Scale {
	return &NullableV1beta1Scale{value: val, isSet: true}
}
