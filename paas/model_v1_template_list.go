...
// checks if the V1TemplateList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1TemplateList{}
...
type NullableV1TemplateList struct {
	value *V1TemplateList
	isSet bool
}

func (v NullableV1TemplateList) Get() *V1TemplateList {
	return v.value
}

func (v *NullableV1TemplateList) Set(val *V1TemplateList) {
	v.value = val
	v.isSet = true
}
...
func NewNullableV1TemplateList(val *V1TemplateList) *NullableV1TemplateList {
	return &NullableV1TemplateList{value: val, isSet: true}
}
