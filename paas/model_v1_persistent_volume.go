...
// checks if the V1PersistentVolume type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1PersistentVolume{}
...
func (o *V1PersistentVolume) GetSpec() V1PersistentVolumeSpec {
	if o == nil || IsNil(o.Spec) {
		var ret V1PersistentVolumeSpec
		return ret
	}
	return *o.Spec
}
...
func (o *V1PersistentVolume) GetStatus() V1PersistentVolumeStatus {
	if o == nil || IsNil(o.Status) {
		var ret V1PersistentVolumeStatus
		return ret
	}
	return *o.Status
}
...
type NullableV1PersistentVolume struct {
	value *V1PersistentVolume
	isSet bool
}

func (v NullableV1PersistentVolume) Get() *V1PersistentVolume {
	return v.value
}

func (v *NullableV1PersistentVolume) Set(val *V1PersistentVolume) {
	v.value = val
	v.isSet = true
}
...
func NewNullableV1PersistentVolume(val *V1PersistentVolume) *NullableV1PersistentVolume {
	return &NullableV1PersistentVolume{value: val, isSet: true}
}
