...
// checks if the V1ComponentStatusList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1ComponentStatusList{}
...
type NullableV1ComponentStatusList struct {
	value *V1ComponentStatusList
	isSet bool
}

func (v NullableV1ComponentStatusList) Get() *V1ComponentStatusList {
	return v.value
}

func (v *NullableV1ComponentStatusList) Set(val *V1ComponentStatusList) {
	v.value = val
	v.isSet = true
}

func (v NullableV1ComponentStatusList) IsSet() bool {
	return v.isSet
}
...
func NewNullableV1ComponentStatusList(val *V1ComponentStatusList) *NullableV1ComponentStatusList {
	return &NullableV1ComponentStatusList{value: val, isSet: true}
}
