...
// checks if the V1CinderPersistentVolumeSource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1CinderPersistentVolumeSource{}
...
func NewV1CinderPersistentVolumeSource(volumeID string) *V1CinderPersistentVolumeSource {
	this := V1CinderPersistentVolumeSource{}
...
type NullableV1CinderPersistentVolumeSource struct {
	value *V1CinderPersistentVolumeSource
	isSet bool
}

func (v NullableV1CinderPersistentVolumeSource) Get() *V1CinderPersistentVolumeSource {
	return v.value
}

func (v *NullableV1CinderPersistentVolumeSource) Set(val *V1CinderPersistentVolumeSource) {
	v.value = val
	v.isSet = true
}

func (v NullableV1CinderPersistentVolumeSource) IsSet() bool {
	return v.isSet
}

func (v *NullableV1CinderPersistentVolumeSource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV1CinderPersistentVolumeSource(val *V1CinderPersistentVolumeSource) *NullableV1CinderPersistentVolumeSource {
	return &NullableV1CinderPersistentVolumeSource{value: val, isSet: true}
}
