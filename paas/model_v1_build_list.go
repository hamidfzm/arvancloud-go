...
// checks if the V1BuildList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1BuildList{}
...
func (v NullableV1BuildList) Get() *V1BuildList {
	return v.value
}
...
func NewNullableV1BuildList(val *V1BuildList) *NullableV1BuildList {
	return &NullableV1BuildList{value: val, isSet: true}
}
