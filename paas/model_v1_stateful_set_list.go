...
// checks if the V1StatefulSetList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1StatefulSetList{}
...
type NullableV1StatefulSetList struct {
	value *V1StatefulSetList
	isSet bool
}

func (v NullableV1StatefulSetList) Get() *V1StatefulSetList {
	return v.value
}

func (v *NullableV1StatefulSetList) Set(val *V1StatefulSetList) {
	v.value = val
	v.isSet = true
}
...
func NewNullableV1StatefulSetList(val *V1StatefulSetList) *NullableV1StatefulSetList {
	return &NullableV1StatefulSetList{value: val, isSet: true}
}
