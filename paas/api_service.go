...
func (r ApiCreateNamespacedServiceRequest) Body(body V1Service) ApiCreateNamespacedServiceRequest {
	r.body = &body
	return r
}

// If &#39;true&#39;, then the output is pretty printed.
func (r ApiCreateNamespacedServiceRequest) Pretty(pretty string) ApiCreateNamespacedServiceRequest {
	r.pretty = &pretty
	return r
}

func (r ApiCreateNamespacedServiceRequest) Execute() (*V1Service, *http.Response, error) {
	return r.ApiService.CreateNamespacedServiceExecute(r)
}
...
func (a *ServiceAPIService) CreateNamespacedServiceExecute(r ApiCreateNamespacedServiceRequest) (*V1Service, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ServiceAPIService.CreateNamespacedService")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/namespaces/{namespace}/services"
...
func (r ApiDeleteNamespacedServiceRequest) Body(body V1DeleteOptions) ApiDeleteNamespacedServiceRequest {
	r.body = &body
	return r
}

// If &#39;true&#39;, then the output is pretty printed.
func (r ApiDeleteNamespacedServiceRequest) Pretty(pretty string) ApiDeleteNamespacedServiceRequest {
	r.pretty = &pretty
	return r
}
...
func (r ApiDeleteNamespacedServiceRequest) Execute() (*V1Status, *http.Response, error) {
	return r.ApiService.DeleteNamespacedServiceExecute(r)
}
...
func (a *ServiceAPIService) DeleteNamespacedServiceExecute(r ApiDeleteNamespacedServiceRequest) (*V1Status, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ServiceAPIService.DeleteNamespacedService")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/namespaces/{namespace}/services/{name}"
	localVarPath = strings.Replace(localVarPath, "{"+"namespace"+"}", url.PathEscape(parameterValueToString(r.namespace, "namespace")), -1)
...
// If &#39;true&#39;, then the output is pretty printed.
func (r ApiListNamespacedServiceRequest) Pretty(pretty string) ApiListNamespacedServiceRequest {
	r.pretty = &pretty
	return r
}

// A selector to restrict the list of returned objects by their labels. Defaults to everything.
func (r ApiListNamespacedServiceRequest) LabelSelector(labelSelector string) ApiListNamespacedServiceRequest {
	r.labelSelector = &labelSelector
	return r
}

// A selector to restrict the list of returned objects by their fields. Defaults to everything.
func (r ApiListNamespacedServiceRequest) FieldSelector(fieldSelector string) ApiListNamespacedServiceRequest {
...
func (r ApiListNamespacedServiceRequest) Watch(watch bool) ApiListNamespacedServiceRequest {
	r.watch = &watch
	return r
}
...
func (r ApiListNamespacedServiceRequest) TimeoutSeconds(timeoutSeconds int32) ApiListNamespacedServiceRequest {
...
func (r ApiListNamespacedServiceRequest) Limit(limit int32) ApiListNamespacedServiceRequest {
	r.limit = &limit
	return r
}
...
func (r ApiListNamespacedServiceRequest) Continue_(continue_ string) ApiListNamespacedServiceRequest {
	r.continue_ = &continue_
	return r
}

func (r ApiListNamespacedServiceRequest) Execute() (*V1ServiceList, *http.Response, error) {
	return r.ApiService.ListNamespacedServiceExecute(r)
}
...
func (a *ServiceAPIService) ListNamespacedServiceExecute(r ApiListNamespacedServiceRequest) (*V1ServiceList, *http.Response, error) {
	var (
		...
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *V1ServiceList
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ServiceAPIService.ListNamespacedService")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiPatchNamespacedServiceRequest) Body(body map[string]interface{}) ApiPatchNamespacedServiceRequest {
	r.body = &body
	return r
}

// If &#39;true&#39;, then the output is pretty printed.
func (r ApiPatchNamespacedServiceRequest) Pretty(pretty string) ApiPatchNamespacedServiceRequest {
	r.pretty = &pretty
	return r
}

func (r ApiPatchNamespacedServiceRequest) Execute() (*V1Service, *http.Response, error) {
	return r.ApiService.PatchNamespacedServiceExecute(r)
}
...
func (a *ServiceAPIService) PatchNamespacedServiceExecute(r ApiPatchNamespacedServiceRequest) (*V1Service, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ServiceAPIService.PatchNamespacedService")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
// If &#39;true&#39;, then the output is pretty printed.
func (r ApiReadNamespacedServiceRequest) Pretty(pretty string) ApiReadNamespacedServiceRequest {
	r.pretty = &pretty
	return r
}

// Should this value be exported.  Export strips fields that a user can not specify.
func (r ApiReadNamespacedServiceRequest) Export(export bool) ApiReadNamespacedServiceRequest {
	r.export = &export
	return r
}

// Should the export be exact.  Exact export maintains cluster-specific fields like &#39;Namespace&#39;.
func (r ApiReadNamespacedServiceRequest) Exact(exact bool) ApiReadNamespacedServiceRequest {
	r.exact = &exact
	return r
}

func (r ApiReadNamespacedServiceRequest) Execute() (*V1Service, *http.Response, error) {
	return r.ApiService.ReadNamespacedServiceExecute(r)
}
...
func (a *ServiceAPIService) ReadNamespacedServiceExecute(r ApiReadNamespacedServiceRequest) (*V1Service, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ServiceAPIService.ReadNamespacedService")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiReplaceNamespacedServiceRequest) Body(body V1Service) ApiReplaceNamespacedServiceRequest {
	r.body = &body
	return r
}

// If &#39;true&#39;, then the output is pretty printed.
func (r ApiReplaceNamespacedServiceRequest) Pretty(pretty string) ApiReplaceNamespacedServiceRequest {
	r.pretty = &pretty
	return r
}

func (r ApiReplaceNamespacedServiceRequest) Execute() (*V1Service, *http.Response, error) {
	return r.ApiService.ReplaceNamespacedServiceExecute(r)
}
...
func (a *ServiceAPIService) ReplaceNamespacedServiceExecute(r ApiReplaceNamespacedServiceRequest) (*V1Service, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ServiceAPIService.ReplaceNamespacedService")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
