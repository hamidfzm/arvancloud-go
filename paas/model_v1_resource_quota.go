...
// checks if the V1ResourceQuota type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1ResourceQuota{}
...
type NullableV1ResourceQuota struct {
	value *V1ResourceQuota
	isSet bool
}

func (v NullableV1ResourceQuota) Get() *V1ResourceQuota {
	return v.value
}

func (v *NullableV1ResourceQuota) Set(val *V1ResourceQuota) {
	v.value = val
	v.isSet = true
}
...
func NewNullableV1ResourceQuota(val *V1ResourceQuota) *NullableV1ResourceQuota {
	return &NullableV1ResourceQuota{value: val, isSet: true}
}
