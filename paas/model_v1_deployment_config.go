...
// checks if the V1DeploymentConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1DeploymentConfig{}
...
func (o *V1DeploymentConfig) GetSpec() V1DeploymentConfigSpec {
	if o == nil {
		var ret V1DeploymentConfigSpec
		return ret
	}
...
func (o *V1DeploymentConfig) GetStatus() V1DeploymentConfigStatus {
	if o == nil || IsNil(o.Status) {
		var ret V1DeploymentConfigStatus
		return ret
	}
	return *o.Status
}
...
type NullableV1DeploymentConfig struct {
	value *V1DeploymentConfig
	isSet bool
}

func (v NullableV1DeploymentConfig) Get() *V1DeploymentConfig {
	return v.value
}

func (v *NullableV1DeploymentConfig) Set(val *V1DeploymentConfig) {
	v.value = val
	v.isSet = true
}
...
func NewNullableV1DeploymentConfig(val *V1DeploymentConfig) *NullableV1DeploymentConfig {
	return &NullableV1DeploymentConfig{value: val, isSet: true}
}
