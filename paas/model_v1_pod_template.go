...
// checks if the V1PodTemplate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1PodTemplate{}
...
func (v NullableV1PodTemplate) Get() *V1PodTemplate {
	return v.value
}
...
func NewNullableV1PodTemplate(val *V1PodTemplate) *NullableV1PodTemplate {
	return &NullableV1PodTemplate{value: val, isSet: true}
}
