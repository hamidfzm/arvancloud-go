...
// checks if the V1BuildConfigList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1BuildConfigList{}
...
type NullableV1BuildConfigList struct {
	value *V1BuildConfigList
	isSet bool
}

func (v NullableV1BuildConfigList) Get() *V1BuildConfigList {
	return v.value
}

func (v *NullableV1BuildConfigList) Set(val *V1BuildConfigList) {
	v.value = val
	v.isSet = true
}
...
func NewNullableV1BuildConfigList(val *V1BuildConfigList) *NullableV1BuildConfigList {
	return &NullableV1BuildConfigList{value: val, isSet: true}
}
