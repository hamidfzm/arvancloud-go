...
// checks if the V1PodList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1PodList{}
...
func NewNullableV1PodList(val *V1PodList) *NullableV1PodList {
	return &NullableV1PodList{value: val, isSet: true}
}
