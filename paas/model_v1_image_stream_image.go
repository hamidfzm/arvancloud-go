...
// checks if the V1ImageStreamImage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1ImageStreamImage{}
...
type NullableV1ImageStreamImage struct {
	value *V1ImageStreamImage
	isSet bool
}

func (v NullableV1ImageStreamImage) Get() *V1ImageStreamImage {
	return v.value
}

func (v *NullableV1ImageStreamImage) Set(val *V1ImageStreamImage) {
	v.value = val
	v.isSet = true
}
...
func NewNullableV1ImageStreamImage(val *V1ImageStreamImage) *NullableV1ImageStreamImage {
	return &NullableV1ImageStreamImage{value: val, isSet: true}
}
